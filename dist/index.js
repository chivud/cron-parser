...
exports.parseCronExpression = void 0;
const allowedRanges = [
...
const wildcardParser = (min, max) => {
    return Array.from({ length: max - min + 1 }, (_, i) => i + min);
};
const integerParser = (value, min, max, field) => {
...
const rangeParser = (value, min, max, field) => {
...
const listParser = (value, min, max, field) => {
...
const stepParser = (value, min, max, field) => {
