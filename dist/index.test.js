...
describe("Test Cron Expressions", () => {
    test("Valid: * * * * * ls", () => {
        ...
        const result = (0, index_1.parseCronExpression)(expression);
    ...
    test('Invalid char: "👽 * * * * /usr/bin/invalid"', () => {
        ...
        expect(() => (0, index_1.parseCronExpression)(expression)).toThrow("Invalid value '👽' in field minutes");
    });
    test("Invalid value: 60 * * * * /usr/bin/invalid", () => {
        const expression = "60 * * * * /usr/bin/invalid";
        expect(() => (0, index_1.parseCronExpression)(expression)).toThrow("Value '60' out of range for field minutes");
    });
    test("Invalid expression: * * * *", () => {
        const expression = "* * * *";
        expect(() => (0, index_1.parseCronExpression)(expression)).toThrow("Invalid cron expression");
    });
    test("Invalid range: 6-2 0 1,2,3,15 */2 1-5 /usr/bin/find", () => {
        const expression = "6-2 0 1,2,3,15 */2 1-5 /usr/bin/find";
        expect(() => (0, index_1.parseCronExpression)(expression)).toThrow("Invalid range '6-2' in field minutes");
    });
    test("Invalid range: 1-2-3 0 1,2,3,15 */2 1-5 /usr/bin/find", () => {
        const expression = "1-2-3 0 1,2,3,15 */2 1-5 /usr/bin/find";
        expect(() => (0, index_1.parseCronExpression)(expression)).toThrow("Invalid range '1-2-3' in field minutes");
    });
    test("Invalid range: 1-66/5 * * * * /usr/bin/find", () => {
        const expression = "1-66/5 * * * * /usr/bin/find";
        expect(() => (0, index_1.parseCronExpression)(expression)).toThrow("Invalid range '1-66' in field minutes");
    });
    test("Invalid range: 66/15 0 1,2,3,15 */2 1-5 /usr/bin/find", () => {
        const expression = "66/15 0 1,2,3,15 */2 1-5 /usr/bin/find";
        expect(() => (0, index_1.parseCronExpression)(expression)).toThrow("Value '66' out of range for field minutes");
    });
    test('Invalid range: "a-b * * * * /usr/bin/invalid"', () => {
        const expression = "a-b * * * * /usr/bin/invalid";
        expect(() => (0, index_1.parseCronExpression)(expression)).toThrow("Invalid range 'a-b' in field minutes");
    });
    test("Invalid list value: */15 1,2,3 1,2,3,15 */2 1-5 /usr/bin/find", () => {
        const expression = "*/15 1,2,66 1,2,3,15 */2 1-5 /usr/bin/find";
        expect(() => (0, index_1.parseCronExpression)(expression)).toThrow("Invalid list value '66' in field hours");
    });
    test("Invalid step: */* 0 1,2,3,15 */2 1-5 /usr/bin/find", () => {
        const expression = "*/66 0 1,2,3,15 */2 1-5 /usr/bin/find";
        expect(() => (0, index_1.parseCronExpression)(expression)).toThrow("Invalid step value '66' in field minutes");
    });
    test("Invalid step: */* 0 1,2,3,15 */2 1-5 /usr/bin/find", () => {
        const expression = "*/* 0 1,2,3,15 */2 1-5 /usr/bin/find";
        expect(() => (0, index_1.parseCronExpression)(expression)).toThrow("Invalid step value '*' in field minutes");
    });
    test("Invalid step: a/b 0 1,2,3,15 */2 1-5 /usr/bin/find", () => {
        const expression = "a/b 0 1,2,3,15 */2 1-5 /usr/bin/find";
        expect(() => (0, index_1.parseCronExpression)(expression)).toThrow("Invalid step value 'b' in field minutes");
    });
});
